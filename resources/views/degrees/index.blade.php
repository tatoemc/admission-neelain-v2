            ...
            <div class="card-header pb-0">
                <div class="col-sm-1 col-md-2">
                    @can('اضافة برنامج')
                        ...
                        data-toggle="modal" href="#add">أضافة برنامج</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">اسم البرنامج</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف برنامج</h6><button aria-label="Close" class="close"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    ...
                    <h6 class="modal-title">اضافة برنامج</h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
