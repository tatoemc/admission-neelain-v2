...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">الكليات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ قائمة
                الكليات</span>
        </div>
    </div>
</div>
                                    ...
                                    <td>
                                        ...
                                        @can('حذف كلية')
                                            <a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
                                                ...
                                                data-facultyname="{{ $faculty->name }}" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">حذف الكلية</h6><button aria-label="Close" class="close"
                        data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ route('faculties.destroy', 'test') }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <p>هل انت متاكد من عملية الحذف ؟</p><br>
                        <input type="hidden" name="faculty_id" id="faculty_id" value="">
                        <input class="form-control" name="facultyname" id="facultyname" type="text" readonly>
                    </div>
...
<script>
    $('#modaldemo8').on('show.bs.modal', function(event) {
        ...
        var facultyname = button.data('facultyname')
        var modal = $(this)
        modal.find('.modal-body #faculty_id').val(faculty_id);
        modal.find('.modal-body #facultyname').val(facultyname);
    })
</script>
